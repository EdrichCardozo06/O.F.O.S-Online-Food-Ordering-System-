        ...
        <div class="page-wrapper">
            ...
            <section class="restaurants-page">
                <div class="container">
					...
					</table>							<a href="delete_orders.php?order_del=<?php echo $row['o_id'];?>" onclick="return confirm('Download your order?');" class="btn btn-success btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-download" style="font-size:16px"></i></a>	
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                   ...
                                   <p>Online Food Ordering DBMS project by 20CE21.</p></div>
                            </div>
                        </div>
                    </div>

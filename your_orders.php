                    ...
                    <div class="row">
						...
						$query_res= mysqli_query($db,"select * from users_orders where u_id='".$_SESSION['user_id']."'");
							...
							?>
												...
												<a href="delete_orders.php?order_del=<?php echo $row['u_id'];?>" onclick="return confirm('Download your order?');" class="btn btn-success btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-download" style="font-size:16px"></i></a>	
